...
object sparkdataframe {
  def main(args: Array[String]) {
    ...
    */
    ...
    val stationdata = spark.read.option("header", "true").csv("C:\\Users\\prudh\\Downloads\\ICP 6\\Datasets\\201508_station_data.csv")
    val tripdata = spark.read.option("header", "true").csv("C:\\Users\\prudh\\Downloads\\ICP 6\\Datasets\\201508_trip_data.csv")
    ...
    //5.save graph
    stationGraph.vertices.write.parquet("C:\\Users\\prudh\\Downloads\\ICP 6\\Output")
    stationGraph.edges.write.parquet("C:\\Users\\prudh\\Downloads\\ICP 6\\Output")
